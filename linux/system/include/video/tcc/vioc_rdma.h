...
extern void VIOC_RDMA_SetImageR2YMode(VIOC_RDMA *pRDMA, unsigned int y2r_mode);
...
#ifdef CONFIG_ARCH_TCC898X
extern void VIOC_RDMA_DEC_CTRL(VIOC_RDMA *pRDMA, unsigned int base, unsigned int length, unsigned int has_alpha, unsigned int has_comp);
extern void VIOC_RDMA_DEC_EN(VIOC_RDMA *pRDMA, unsigned int OnOff);
#endif
#endif
