...
typedef	enum	{	
			...
			DMD_E_INFO_DVBC_CONSTELLATION = 14,//20130418,troy.wang added for SQI calculation.
			DMD_E_INFO_DVBC_SQI = 15, //20130418,troy.wang added, DVBC SQI calculation, as it's has no SPEC to obey, and the coding method(conventional + RS) is same as DVB-T, so the arithmetic is same as DVB-T. 
