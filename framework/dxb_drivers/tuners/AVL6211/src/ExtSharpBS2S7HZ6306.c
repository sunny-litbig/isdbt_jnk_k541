...
///$Date: 2012-3-8 21:47 $
///
#include "../include/SharpBS2S7HZ6306.h"
#include "../include/ExtSharpBS2S7HZ6306.h"
#include "../include/II2CRepeater.h"
...
AVL_DVBSx_ErrorCode ExtSharpBS2S7HZ6306_Check_I2C_Address(AVL_puint16 Address, struct AVL_DVBSx_Chip * pAVLChip)
{
	AVL_DVBSx_ErrorCode r;
	AVL_Tuner Tuner;
	...
	pTuner->m_uiI2CBusClock_kHz = 200;
